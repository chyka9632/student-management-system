...
class EditDialog(QDialog):
    def __init__(self):
        ...
        # Grab the student name from selected row
        index = main_window.table.currentRow()
        student_name = main_window.table.item(index, 1).text()

        # Grab id from selected row
        ...
        # Add mobile phone number widget
        mobile_phone_number = main_window.table.item(index, 3).text()
        self.mobile_phone_number = QLineEdit(mobile_phone_number)
        self.mobile_phone_number.setPlaceholderText("Phone")
...
class DeleteDialog(QDialog):
    def __init__(self):
        ...
        layout = QGridLayout()
        confirmation = QLabel(f"Are you sure you want delete {student_name}?")
        yes = QPushButton("Yes")
        no = QPushButton("No")
    ...
    def delete_student(self):
        ...
        confirmation_widget.setText(f"{student_name}'s data was successfully deleted")
